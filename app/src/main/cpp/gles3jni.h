...
public:
    ...
    int m_displayWidth=512;
    int m_displayHeight=512;
    int m_width =512;
    int m_height=512;
    void displayRGBFrame(unsigned char *frameRGB, int m_displayWidth, int m_displayHeight);
    void convertYUVToRGB(unsigned char *frame, unsigned char *frameRGB, int w, int h);
