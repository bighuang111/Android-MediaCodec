...
public class NewVideoDecoder extends Thread {
    ...
    public NewVideoDecoder(Surface surface, String path) {
    ...
    public void run() {
        ...
        try {
            ...
            ByteBuffer buffer = ByteBuffer.allocate(65536000);
...
//        mediaFormat.setByteBuffer("csd-0", ByteBuffer.wrap(vps));
//        mediaFormat.setByteBuffer("csd-1", ByteBuffer.wrap(sps));
//        mediaFormat.setByteBuffer("csd-2", ByteBuffer.wrap(pps));
